  ...
  return (
    <div className="mx-auto max-w-3xl shell-px py-12">
      ...
      <div className="mt-6 space-y-4 text-zinc-600 dark:text-zinc-400">
        ...
        <p>Photos with minors or sensitive details may be rejected. Organisers can remove content at any time for safety reasons.</p>
        <p>By submitting an image or album, you grant Hayling Bike Night the right to display thumbnails and metadata on this site.</p>
      </div>
    </div>
  );
}
