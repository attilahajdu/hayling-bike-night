...
export default async function OwnerModerationPage() {
  ...
  if (!isOwnerEmail(session.user.email)) {
    return <div className="mx-auto max-w-lg shell-px py-16 text-center"><h1 className="font-display font-bold text-3xl text-zinc-200">No access</h1><p className="mt-4 text-zinc-400">Your account is not listed as an organiser.</p></div>;
  }
